    ...
    <div className="flex flex-col">
      ...
      <div className="bg-[#fff]">
        <div className="flex flex-col gap-6 p-6 border-border border">
          <div>
            <p
              className={`text-white max-w-min uppercase font-bold text-xs p-2 ${
                state ? "bg-open" : "bg-close"
              }`}
            >
          ...
          <div className="flex flex-col gap-2">
            <h1 className="laptop:text-2xl font-bold ">{title}</h1>
        ...
        <button className="w-full text-sm bg-blue text-white uppercase font-semibold p-5">
          Quero saber mais
        </button>
      </div>
    </div>
